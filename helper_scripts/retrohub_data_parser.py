...
print("|SYSTEMS|")
for system in system_data["systems_list"]:
	system = expand_definition(system, system_data["systems_list"])
...
print("|EMULATORS|")
for emulator in emulator_data["emulators_list"]:
	emulator = expand_definition(emulator, emulator_data["emulators_list"])
	...
	output = f""".. _emulator_{emulator_name}:
