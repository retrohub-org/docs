...
Every game data keeps a reference of the system name it comes from, so you can use this to check whether this game data belongs to the current system view.
